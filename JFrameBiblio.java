...
public class JFrameBiblio extends javax.swing.JFrame 
{
    ...
    private void jMenuItemAuthorsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemAuthorsActionPerformed
        JOptionPane.showMessageDialog(null, "Projekt zaliczeniowy: \"Biblioteka multimedialna\"\n" +
                ...
                "\n" +
                "Dzięki naszemu programowi może łatwo i bez przeszkód stworzyć baze składającą się z plików txt oraz jpg,\n" +
                " zapisać ją na komputrze a potem gdy tego potrzebuje możemy ją otworzyć w każdym momencie. \n" +
                "\n" +
                "\n" +
                "Sterowanie:\n" +
                "-Tworzenie bazy: \n" +
                "1. Klikamy \"plik\" po czym \"nowy\" \n" +
                "2. wybieramy rodzaj pliku z listy: tekstowy lub zdjecie\n" +
                ...
                "4. Wybrany plik pojawia nam się w oknie po prawej\n" +
                ...
                "3. Po otowrzeniu bazy może znowu dodawać nowe elementy, usuwać stare, przeglądać zdjęcia i pliki txt.", "Informacja", JOptionPane.INFORMATION_MESSAGE);
